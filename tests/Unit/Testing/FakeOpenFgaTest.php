...
covers(FakeOpenFga::class);

describe('FakeOpenFga', function () {
    beforeEach(function () {
        $this->fake = new FakeOpenFga;
    });

    describe('assertions', function () {
        describe('assertBatchWritten', function () {
            it('fails when no batch performed', function () {
            ...
            it('passes when batch performed', function () {
        ...
        describe('assertCheckCount', function () {
        ...
        describe('assertChecked', function () {
            it('fails when check not performed', function () {
            ...
            it('passes when check performed', function () {
                $this->fake->check('user:1', 'reader', 'document:1');
        ...
        describe('assertGranted', function () {
        ...
        describe('assertNoBatchWrites', function () {
            it('fails when batch performed', function () {
                $this->fake->writeBatch([['user' => 'user:1', 'relation' => 'reader', 'object' => 'document:1']]);
            ...
            it('passes when no batches performed', function () {
                // Should not throw
                expect(function () {
        ...
        describe('assertNoChecks', function () {
        ...
        describe('assertNotGranted', function () {
    ...
    describe('functionality', function () {
        it('can expand relations', function () {
            $this->fake->grant('user:1', 'reader', 'document:1');
        ...
        it('can grant and check permissions', function () {
            $this->fake->grant('user:1', 'reader', 'document:1');
        ...
        it('can mock check responses', function () {
        ...
        it('can mock list objects responses', function () {
        ...
        it('can reset failure state', function () {
        ...
        it('can simulate custom failures', function () {
        ...
        it('records check operations', function () {
            $this->fake->check('user:1', 'reader', 'document:1');
            $this->fake->check('user:1', 'writer', 'document:1');
