...
use OpenFGA\Laravel\Tests\User;

class SpatieCompatibilityTest extends TestCase
{
    ...
    public function test_has_permission_to_works()
    {
    ...
    public function test_has_role_works()
    {
        $fake = $this->getFakeOpenFga();
    ...
    public function test_has_any_role_works()
    {
        $fake = $this->getFakeOpenFga();
    ...
    public function test_has_all_roles_works()
    {
        $fake = $this->getFakeOpenFga();
        $fake->grant($this->user->authorizationUser(), 'admin', 'organization:main');
        $fake->grant($this->user->authorizationUser(), 'editor', 'organization:main');
    ...
    public function test_assign_role_works()
    {
    ...
    public function test_remove_role_works()
    {
        $fake = $this->getFakeOpenFga();
        $fake->grant($this->user->authorizationUser(), 'admin', 'organization:main');
    ...
    public function test_give_permission_to_works()
    {
    ...
    public function test_revoke_permission_to_works()
    {
        $fake = $this->getFakeOpenFga();
    ...
    public function test_sync_roles_works()
    {
        $fake = $this->getFakeOpenFga();
        $fake->grant($this->user->authorizationUser(), 'admin', 'organization:main');
        $fake->grant($this->user->authorizationUser(), 'editor', 'organization:main');
    ...
    public function test_permission_mapping_works()
    {
    ...
    public function test_role_mapping_works()
    {
    ...
    public function test_permission_inference_works()
    {
        $fake = $this->getFakeOpenFga();
    ...
    public function test_get_all_permissions_works()
    {
        $fake = $this->getFakeOpenFga();
        $fake->grant($this->user->authorizationUser(), 'editor', 'post:*');
    ...
    public function test_get_role_names_works()
    {
        $fake = $this->getFakeOpenFga();
        $fake->grant($this->user->authorizationUser(), 'admin', 'organization:main');
        $fake->grant($this->user->authorizationUser(), 'editor', 'organization:main');
    ...
    public function test_context_parameter_works()
    {
        $fake = $this->getFakeOpenFga();
    ...
    public function test_model_context_works()
    {
        $post = new class {
