...
class SnapshotTestingTest extends TestCase
{
    use RefreshDatabase, FakesOpenFga, SnapshotsTesting;
    ...
    public function test_basic_permission_snapshot()
    {
        ...
        $this->assertPermissionsMatchSnapshot('basic_permissions', function ($snapshot) {
            $snapshot->captureUserPermissions('user:1', 
                ['document:1', 'document:2'],
                ['owner', 'editor', 'viewer']
            );
            
            $snapshot->captureUserPermissions('user:2',
                ['document:1', 'document:2'],
                ['owner', 'editor', 'viewer']
            );
        });
    ...
    public function test_permission_matrix_snapshot()
    {
    ...
    public function test_object_relationships_snapshot()
    {
    ...
    public function test_complex_scenario_snapshot()
    {
        ...
        $this->assertPermissionsMatchSnapshot('complex_organization', function ($snapshot) {
            ...
            $snapshot->captureUserPermissions('user:dev1',
                ['document:api-spec', 'document:roadmap'],
                ['owner', 'editor', 'viewer']
            );
            
            $snapshot->captureUserPermissions('user:dev2',
                ['document:api-spec', 'document:roadmap'],
                ['owner', 'editor', 'viewer']
            );
        });
    ...
    public function test_snapshot_detects_permission_changes()
    {
        ...
        $this->assertPermissionsMatchSnapshot('initial_state', function ($snapshot) {
    ...
    public function test_comparing_snapshots()
    {
        $fake = $this->getFakeOpenFga();
    ...
    public function test_updating_snapshots()
    {
        ...
        $this->assertPermissionsMatchSnapshot('updatable_snapshot', function ($snapshot) {
