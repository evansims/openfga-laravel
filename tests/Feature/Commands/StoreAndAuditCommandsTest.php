...
class StoreAndAuditCommandsTest extends TestCase
{
    public function test_store_create_command()
    {
    ...
    public function test_store_create_command_with_model()
    {
    ...
    public function test_store_create_command_with_invalid_model()
    {
        $this->artisan('openfga:store:create', [
            'name' => 'TestStore',
    ...
    public function test_audit_permissions_command_for_user()
    {
    ...
    public function test_audit_permissions_command_for_object()
    {
    ...
    public function test_audit_permissions_command_general()
    {
    ...
    public function test_audit_permissions_command_with_export_json()
    {
        $this->artisan('openfga:audit', [
            '--user' => 'user:123',
            '--export' => 'json',
    ...
    public function test_audit_permissions_command_with_export_csv()
    {
        $this->artisan('openfga:audit', [
            '--user' => 'user:123',
            '--export' => 'csv',
    ...
    public function test_analyze_permissions_command_default()
    {
    ...
    public function test_analyze_permissions_command_show_paths()
    {
    ...
    public function test_analyze_permissions_command_find_conflicts()
    {
    ...
    public function test_analyze_permissions_command_optimize()
    {
    ...
    public function test_analyze_permissions_command_all_options()
    {
        $this->artisan('openfga:analyze', [
            '--show-paths' => true,
            '--find-conflicts' => true,
