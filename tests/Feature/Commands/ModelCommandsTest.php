...
class ModelCommandsTest extends TestCase
{
    ...
    public function test_model_create_command_with_template()
    {
    ...
    public function test_model_create_command_with_organization_template()
    {
        $this->artisan('openfga:model:create', [
            'name' => 'OrgModel',
    ...
    public function test_model_create_command_with_file()
    {
    ...
    public function test_model_create_command_interactive()
    {
    ...
    public function test_model_create_command_fails_without_force_when_file_exists()
    {
    ...
    public function test_model_create_command_overwrites_with_force()
    {
    ...
    public function test_model_validate_command_with_valid_dsl()
    {
        $validDsl = <<<'DSL'
model
  schema 1.1
...
DSL;
    ...
    public function test_model_validate_command_with_invalid_dsl()
    {
        $invalidDsl = <<<'DSL'
  schema 1.1
...
DSL;
    ...
    public function test_model_validate_command_with_json_output()
    {
        $validDsl = "model\n  schema 1.1\n\ntype user";
    ...
    public function test_model_validate_command_without_file()
    {
        $this->artisan('openfga:model:validate')
    ...
    public function test_model_validate_command_with_nonexistent_file()
    {
